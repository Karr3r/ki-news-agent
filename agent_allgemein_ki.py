...
Du erhältst eine Liste neuer Studien (Titel + Abstract) aus peer-reviewten Journalen, Konferenzbeiträgen (NeurIPS, ICLR, IEEE, ACM, SOSP, SIGCOMM) und Preprints (arXiv).
...
Formuliere ausschließlich empirisch und wissenschaftlich fundiert – ohne Marketing oder Spekulation.
Hinweis: Nur Studien mit einer Bewertung von 10 gelten als unmittelbar strategisch relevant.
"""
